...
**Tests:**
- `node plugin/scripts/check-skills-drift.js` — "Check 2: sdd-help/SKILL.md All Skills section lists every skill with a current blurb; exits non-zero when a skill is missing, orphaned, or has a stale description"
- `node plugin/scripts/gen-sdd-help-skills.js --update && node plugin/scripts/check-skills-drift.js` — "generator regenerates the All Skills section from SKILL.md frontmatter and check passes after update"
