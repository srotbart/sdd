...
**Tests:**
hub/server/spec-arch-http.test.ts > SPEC-arch-010/030/037: GET /workspaces > SPEC-arch-030: each workspace entry is enriched with counts, agents and lastActivity — "GET /workspaces entries are enriched with counts, agent IDs and lastActivity"
